                ...
                <table id="custom-data-table" class="table table-bordered table-striped">
                  ...
                  ?>
                    <tr id="row<?php echo $row->id?>">
                        ...
                        <td>
                            <a href="<?php echo base_url('edit-user/').$row->id?>" class="btn btn-info btn-sm" <?php echo (isset($permissions[2]['write']) && !$permissions[2]['write'] ? 'disabled style="pointer-events: none; cursor: not-allowed;"' : '') ?>><i class="fas fa-edit"></i></a>
                            <a class="btn btn-danger btn-sm" onclick="checkdelete(<?php echo $row->id?>)" <?php echo (isset($permissions[2]['delete']) && !$permissions[2]['delete'] ? 'disabled style="pointer-events: none; cursor: not-allowed;"' : '') ?>><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                  <?php endforeach?>
                  </tbody>
