...
<head>
  ...
  <title>Geo-technical Admin Dashboard | Log in</title>
...
/* body {
    background-image: url(<?php echo base_url('assets/admin/images/login-bg.jpg')?>);
...
<div class="login-box">
  <div class="login-logo">
    <a href="javascript:void(0)">
        <img src="<?php echo base_url('assets/admin/images/logo.png')?>" style="width: 200px;">
    </a>
    <h3>Client Login</h3>
  </div>
  <!-- /.login-logo -->
...
<script>
    ...
    {
        $.ajax({
           url: '<?=base_url('client-login-auth')?>',
           type: 'post',
