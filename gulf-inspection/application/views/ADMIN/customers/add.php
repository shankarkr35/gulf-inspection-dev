        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add New Contact Person</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        const reg_email = /^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$/;
            ...
            if(name!="" && email!="" &&reg_email.test(email) && phone!="" && password!="" &&password.length>=6)
            {
            ...
            $.ajax({
                url: baseUrl + "create-new-contact-person",
                type: "POST",
                data: fd,
                contentType: false,
                processData: false,
