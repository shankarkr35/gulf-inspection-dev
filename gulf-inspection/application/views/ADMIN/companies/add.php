              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-en" placeholder="Name Company.*">
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(name=="")
        {
            ...
            $('#name-err').text('Enter Company Name.*');
        }else{
        ...
        if(name!="")
        {
            ...
            fd.append('name',name);
            $.ajax({
                url: baseUrl + "create-new-company",
                type: "POST",
                data: fd,
                contentType: false,
                processData: false,
                ...
                success: function(jsonStr) {
                  ...
                  if ((responseData != null) && (responseData == 'new record inserted successfully')) 
                  {
                    ...
                    $('#name-en').addClass('is-invalid');
                    $('#name-err').text('Company Name already Exist.*');
                  }
