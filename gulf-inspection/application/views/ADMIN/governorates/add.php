        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add New Governorate</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-en" placeholder="Name Governorate.*">
...
<script>
    $(document).on('click','#save-btn-custom',function(){
        ...
        if(name=="")
        {
            ...
            $('#name-err').text('Enter Governorate Name.*');
        }else{
        ...
        if(name!="")
        {
            ...
            fd.append('name',name);
            $.ajax({
                url: baseUrl + "create-new-governorate",
                type: "POST",
                data: fd,
                contentType: false,
                processData: false,
                ...
                success: function(jsonStr) {
                  ...
                  if ((responseData != null) && (responseData == 'new record inserted successfully')) 
                  {
                    ...
                    window.location.href = baseUrl+'governorate-list';
                  } else if((responseData != null) && (responseData == 'name already exist')) {
                    $('#name-en').addClass('is-invalid');
                    $('#name-err').text('Governorate Name already Exist.*');
                  }
