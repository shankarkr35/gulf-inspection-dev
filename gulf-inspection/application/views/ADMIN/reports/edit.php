                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control form-control-sm" id="report_date" value="<?php echo $record->report_date ?>">
                                <span class="text-danger font-weight-bold" id="report_date-err"></span>
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Report Title :</label>
                                <input type="text" class="form-control form-control-sm" id="report_title" value="<?php echo $record->report_title ?>">
                            ...
                            <div class="form-group report-address Address1">
                                ...
                                <textarea class="form-control form-control-sm" id="address1"><?php echo $record->address1 ?></textarea>
                                <span class="text-danger font-weight-bold" id="address1-err"></span>
                            </div>
                            <div class="form-group report-address Address1">
                                <label for="exampleInputEmail1">Address-2 :</label>
                                <textarea class="form-control form-control-sm" id="address2"><?php echo $record->address2 ?></textarea>
                        ...
                        <div class="col-md">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="client_ref_no" value="<?php echo $record->client_ref_no ?>">
                                <span class="text-danger font-weight-bold" id="client_ref_no-err"></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Client Email:</label>
                                <input type="text" class="form-control form-control-sm" id="client_email" value="<?php echo $record->client_email ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="white-box">
                                    <input type="file" id="file" name="file" class="dropify" accept=".pdf" data-default-file="<?php echo base_url('uploads/').$record->report_doc; ?>" /> 
                                </div>
                            </div>
